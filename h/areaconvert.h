...
#define STRING_VERS "AreaConvert 1.0.1"
#define STRING_SPACER "--------------------------------------------------"
#define STRING_SUPPORTED_SRC "supported src formats: (ack431) rom246b"
#define STRING_SUPPORTED_DST "supported dst formats: (ackfuss)"
...
#define TYPE_INPUT_DEFAULT  TYPE_ACK431
#define TYPE_OUTPUT_DEFAULT TYPE_ACKFUSS
